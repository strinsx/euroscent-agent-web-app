    ...
    >
      ...
      <div className="pt-24 pb-0 px-6 md:px-12">
        ...
        >
          <Link
            to="/"
            className="hover:text-[#1f1f1f]/60 transition-colors"
          >
            Home
          </Link>
            ...
            <div className="flex gap-3">
              {[
                ...
                <button
                  ...
                  className={`flex-1 py-3 border text-xs tracking-[0.15em] uppercase transition-all duration-200 ${
